...
public class Statistics extends JFrame{
    ...
    public void issueBook() { // issueBook method used to fetch table from database and put it into the made table
        try {
            conn con =  new conn();
            ...
            table.setModel(DbUtils.resultSetToTableModel(rs)); // dynamically set data from database into the table
